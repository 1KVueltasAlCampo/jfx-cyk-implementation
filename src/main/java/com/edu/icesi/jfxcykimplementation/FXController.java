...
public class FXController {
    ...
    /**
     * <br> Loads the initial table <br><br>
     * @throws IOException if there is a problem reading the fxml file
     */
    ...
    /**
     * <br> Creates the table of productions <br><br>
     */
    ...
    /**
     * <br> Adds a head of production <br><br>
     */
    @FXML
    ...
    /**
     * <br> Checks if the choice box of initial variables is empty <br><br>
     */
    @FXML
    ...
    /**
     * <br> Checks if a string is generated by the grammar <br><br>
     */
    @FXML
    ...
    /**
     * <br> Rearrange the list of productions so that the production at position 0 is that of the initial variable <br><br>
    ...
    /**
     * <br> Search for a production given the production head <br><br>
     * @param headOfProduction The production head
     * @return The index of the production in the productions list
     */
